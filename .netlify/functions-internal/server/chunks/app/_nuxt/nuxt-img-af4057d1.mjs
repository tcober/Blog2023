...
import { B as encodeParam, l as hasProtocol, C as withLeadingSlash, j as joinURL, p as parseURL, n as defu, D as withBase, E as encodePath } from '../../nitro/netlify.mjs';
...
const getImage$1 = (src, { modifiers = {}, baseURL = storyblockCDN } = {}) => {
  const {
    fit,
    smart,
    width = "0",
...
const storyblokRuntime$ucqq6Qekgj = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage: getImage$1
});
...
const ipxRuntime$9mZKk8Gtjf = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["storyblok"]: { provider: storyblokRuntime$ucqq6Qekgj, defaults: { "baseURL": "https://a-us.storyblok.com" } },
  ["ipx"]: { provider: ipxRuntime$9mZKk8Gtjf, defaults: {} }
};
const useImage = () => {
...
//# sourceMappingURL=nuxt-img-af4057d1.mjs.map
