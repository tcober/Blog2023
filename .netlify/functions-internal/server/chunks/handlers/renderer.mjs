...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[{"defer":true,"src":"https://www.googletagmanager.com/gtag/js?id=G-ZJ8DPDM2QV","async":true}],"noscript":[],"htmlAttrs":{"lang":"en"}};
