...
const inlineAppConfig = {
  "nuxt": {
    "buildId": "1aebf638-7be0-4436-bfcf-215979002757"
  }
};
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/thomascober/Desktop/Blog2023/.data/kv"}));
...
const _yYtj9m = defineEventHandler(async (event) => {
...
const _Ml8e9P = lazyEventHandler(() => {
...
const _lazy_rSWWLj = () => import('../handlers/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_rSWWLj, lazy: true, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _yYtj9m, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _Ml8e9P, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_rSWWLj, lazy: true, middleware: false, method: undefined }
];
